...
/**
 * Destinations used in the [MoviesApp].
 */
...
/**
 * Remembers and creates an instance of [MoviesNavController]
 */
@Composable
fun rememberMoviesNavController(
    navController: NavHostController = rememberNavController()
): MoviesNavController = remember(navController) {
    MoviesNavController(navController)
}
